...
/* harmony import */ var _modules_getCalcForm__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/getCalcForm */ "./src/js/modules/getCalcForm.js");
...
window.addEventListener('DOMContentLoaded', function () {
  var statusForm = {};
  Object(_modules_getCalcForm__WEBPACK_IMPORTED_MODULE_3__["default"])(statusForm);
  Object(_modules_forms__WEBPACK_IMPORTED_MODULE_0__["default"])(statusForm);
  ...
  Object(_modules_timer__WEBPACK_IMPORTED_MODULE_4__["default"])('.timer1', '2021-01-31');
...
/***/ "./src/js/modules/closeModalByTimer.js":
/*!*********************************************!*\
  !*** ./src/js/modules/closeModalByTimer.js ***!
  \*********************************************/
/*! exports provided: default */
...
/* harmony default export */ __webpack_exports__["default"] = (closeModalByTimer);
...
/* harmony import */ var _services_server__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../services/server */ "./src/js/services/server.js");
/* harmony import */ var _checkNum__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./checkNum */ "./src/js/modules/checkNum.js");
/* harmony import */ var _closeModalByTimer__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./closeModalByTimer */ "./src/js/modules/closeModalByTimer.js");
/* harmony import */ var _clearInput__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./clearInput */ "./src/js/modules/clearInput.js");
...
function forms(statusForm) {
  ...
  Object(_checkNum__WEBPACK_IMPORTED_MODULE_8__["default"])('input[name="user_phone"]');
  ...
  function bindPostData(form) {
    form.addEventListener('submit', function (e) {
      ...
      if (form.getAttribute('data-calc') === 'end') {
        for (var key in statusForm) {
          formData.append(key, statusForm[key]);
        }
      }

      var json = JSON.stringify(Object.fromEntries(formData.entries()));
      Object(_services_server__WEBPACK_IMPORTED_MODULE_7__["default"])('http://localhost:3000/posts', json).then(function (data) {
        console.log(data);
        ...
        form.reset();
        Object(_clearInput__WEBPACK_IMPORTED_MODULE_10__["default"])(); // delete obj

        for (var _key in statusForm) {
          delete statusForm[_key];
        }

        Object(_closeModalByTimer__WEBPACK_IMPORTED_MODULE_9__["default"])();
        setTimeout(function () {
...
/* harmony import */ var core_js_modules_web_dom_collections_for_each__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! core-js/modules/web.dom-collections.for-each */ "./node_modules/core-js/modules/web.dom-collections.for-each.js");
/* harmony import */ var core_js_modules_web_dom_collections_for_each__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_web_dom_collections_for_each__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _checkNum__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./checkNum */ "./src/js/modules/checkNum.js");
...
function getCalcForm(statusForm) {
  ...
  Object(_checkNum__WEBPACK_IMPORTED_MODULE_2__["default"])('#width');
  Object(_checkNum__WEBPACK_IMPORTED_MODULE_2__["default"])('#height');
...
/* harmony default export */ __webpack_exports__["default"] = (getCalcForm);
...
__webpack_require__.r(__webpack_exports__);
function images() {
  var imageFilde = document.createElement('div'),
